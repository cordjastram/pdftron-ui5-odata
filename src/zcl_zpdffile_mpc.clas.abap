class ZCL_ZPDFFILE_MPC definition
  public
...
public section.
  ...
  types:
     TS_PDFANNOTATION type ZPDF_ANNOTATION .
  types:
TT_PDFANNOTATION type standard table of TS_PDFANNOTATION .
  types:
  ...
  types:
     TS_PDFFILE type ZPDF_FILE .
  types:
TT_PDFFILE type standard table of TS_PDFFILE .
  types:
     TS_PDFFORMFIELD type ZPDF_FORM_FIELD .
  types:
TT_PDFFORMFIELD type standard table of TS_PDFFORMFIELD .

  constants GC_PDFANNOTATION type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'PdfAnnotation' ##NO_TEXT.
  constants GC_PDFFILE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'PdfFile' ##NO_TEXT.
  constants GC_PDFFORMFIELD type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'PdfFormField' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZPDFFILE_MPC==============CP' ##NO_TEXT.

  methods DEFINE_PDFANNOTATION
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_PDFFILE
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_PDFFORMFIELD
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
CLASS ZCL_ZPDFFILE_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZPDFFILE_SRV' ).

define_pdfannotation( ).
define_pdffile( ).
define_pdfformfield( ).
define_associations( ).
  endmethod.
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'FileToAnnotations' "#EC NOTEXT
                            iv_left_type        = 'PdfFile' "#EC NOTEXT
                            iv_right_type       = 'PdfAnnotation' "#EC NOTEXT
                            iv_right_card       = 'M' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - FileToAnnotations
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'Id'   iv_dependent_property = 'Id' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'FileToAnnotations'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'PdfFiles'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'PdfAnnotations'             "#EC NOTEXT
                                              iv_association_name      = 'FileToAnnotations' ).                                 "#EC NOTEXT

 lo_association = model->create_association(
                            iv_association_name = 'FileToFormFields' "#EC NOTEXT
                            iv_left_type        = 'PdfFile' "#EC NOTEXT
                            iv_right_type       = 'PdfFormField' "#EC NOTEXT
                            iv_right_card       = 'M' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - FileToFormFields
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'Id'   iv_dependent_property = 'Id' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'FileToFormFields'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'PdfFiles'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'PdfFormFields'             "#EC NOTEXT
                                              iv_association_name      = 'FileToFormFields' ).                                 "#EC NOTEXT
...
* Navigation Properties for entity - PdfFile
lo_entity_type = model->get_entity_type( iv_entity_name = 'PdfFile' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'PdfAnnotationSet' "#EC NOTEXT
                                                              iv_abap_fieldname = 'PDFANNOTATIONSET' "#EC NOTEXT
                                                              iv_association_name = 'FileToAnnotations' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'PdfFormFieldSet' "#EC NOTEXT
                                                              iv_abap_fieldname = 'PDFFORMFIELDSET' "#EC NOTEXT
                                                              iv_association_name = 'FileToFormFields' ). "#EC NOTEXT
  endmethod.


  method DEFINE_PDFANNOTATION.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
***********************************************************************************************************************************
*   ENTITY - PdfAnnotation
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'PdfAnnotation' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'InReplyTo' iv_abap_fieldname = 'IN_REPLY_TO' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'PageNr' iv_abap_fieldname = 'PAGE_NR' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'YPos' iv_abap_fieldname = 'YPOS' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZPDF_ANNOTATION'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'PdfAnnotations' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'PdfFile' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 257 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
lo_property->set_nullable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Flattened' iv_abap_fieldname = 'FLATTENED' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'CurrentEditor' iv_abap_fieldname = 'CURRENT_EDITOR' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'FormImported' iv_abap_fieldname = 'FORM_IMPORTED' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZPDF_FILE'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'PdfFiles' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'PdfFormField' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 1024 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
lo_property->set_nullable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZPDF_FORM_FIELD'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'PdfFormFields' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20201226130042'.                  "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'InReplyTo'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'PdfAnnotation'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
ls_text_element-text_symbol            = '002'.              "#EC NOTEXT
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Author'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'PdfAnnotation'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'PageNr'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'PdfAnnotation'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'YPos'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'PdfAnnotation'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_name          = 'ChangedAt'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'PdfFile'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Flattened'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'PdfFile'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'CurrentEditor'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'PdfFile'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'FormImported'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'PdfFile'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
